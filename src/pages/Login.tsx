                ...
                <div className="w-full max-w-md space-y-8">
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <Link to="/forgot-password" className="text-sm font-medium text-accent hover:text-blue-700">
                                Forgot password?
                            </Link>
                        </div>
                        ...
                        <button
                            ...
                            disabled={loading}
                            className="w-full bg-white dark:bg-slate-800 text-gray-700 dark:text-gray-200 font-bold py-3 rounded-lg border border-gray-300 dark:border-slate-700 hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors flex items-center justify-center gap-2"
                        >
                    ...
                    <p className="text-center text-sm text-gray-500">
                        ...
                        <Link to="/register" className="font-bold text-accent hover:text-blue-700">
                            Sign up
                        </Link>
                    </p>
                </div>
