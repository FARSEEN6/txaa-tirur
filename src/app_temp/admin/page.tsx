        ...
        <div className="min-h-screen bg-white text-black">
            <header className="mb-12 flex flex-col md:flex-row justify-between items-start md:items-end gap-6 border-b border-gray-100 pb-8">
                ...
                <div className="flex gap-4">
                    <Link href="/" className="px-8 py-4 border border-gray-200 bg-white text-xs font-bold tracking-[0.2em] uppercase hover:border-black transition-colors">
                        View Site
                    </Link>
                    <Link href="/admin/add-product" className="px-8 py-4 bg-black text-white text-xs font-bold tracking-[0.2em] uppercase hover:bg-gray-800 transition-colors flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                <div className="col-span-1 md:col-span-2">
                    <div className="flex justify-between items-center mb-8 border-b border-gray-100 pb-4">
                        ...
                        <Link href="/admin/orders" className="text-xs font-bold uppercase tracking-wider text-gray-400 hover:text-black transition-colors">View All</Link>
                    </div>
                ...
                <div>
                    ...
                    <div className="space-y-4">
                        <Link href="/admin/home-manager" className="flex items-center justify-between p-6 border border-gray-100 hover:border-black transition-all group bg-white">
                        ...
                        <Link href="/admin/products" className="flex items-center justify-between p-6 border border-gray-100 hover:border-black transition-all group bg-white">
                            <div className="flex items-center gap-4">
                        ...
                        <Link href="/admin/media" className="flex items-center justify-between p-6 border border-gray-100 hover:border-black transition-all group bg-white">
                            <div className="flex items-center gap-4">
                                <ImageIcon size={20} className="text-gray-300 group-hover:text-black transition-colors" />
                        ...
                        <Link href="/admin/settings" className="flex items-center justify-between p-6 border border-gray-100 hover:border-black transition-all group bg-white">
                            <div className="flex items-center gap-4">
