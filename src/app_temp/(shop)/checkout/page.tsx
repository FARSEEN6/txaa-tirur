...
import { Loader2, ShieldCheck, Truck, CreditCard, Banknote, ArrowLeft, Check } from "lucide-react";
...
export default function SimplifiedCheckout() {
    ...
    const { product, loading: productLoading, fetchProduct } = useProductStore();
                    ...
                    <div className="bg-white rounded-2xl p-8 text-center shadow-lg border border-gray-100">
                        ...
                        <p className="text-gray-600 mb-6">
                            Thank you for your order. {formData.paymentMethod === "cod"
                                ? "Pay ₹" + product.price.toLocaleString("en-IN") + " on delivery."
                        ...
                        <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl mb-6">
                            ...
                            <div className="text-left">
                                ...
                                <p className="text-black font-bold">₹{product.price.toLocaleString("en-IN")}</p>
                            </div>
                        </div>
